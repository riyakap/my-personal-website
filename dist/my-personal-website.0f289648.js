...
onScroll();
/* ---------- Cursor friend (smooth follow) ---------- */ const friend = document.getElementById('cursor-friend');
...
step();
/* ---------- Sparkle bursts on hover ---------- */ function makeSparkles(el, count = 10) {
...
/* ---------- Optional confetti on click for projects ---------- */ document.querySelectorAll('.confetti-target').forEach((el)=>{
...
if (heroText) {
    ...
    document.addEventListener('scroll', drift, {
        passive: true
    });
    drift();
}
...
},{}]},["elbaT","gNc1f"], "gNc1f", "parcelRequire079e", {})

//# sourceMappingURL=my-personal-website.0f289648.js.map
